...
class NoFishFoundTabContainerPage extends StatefulWidget {
  const NoFishFoundTabContainerPage({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<NoFishFoundTabContainerBloc>(
      ...
      child: NoFishFoundTabContainerPage(),
    );
  }
}
class NoFishFoundTabContainerPageState
    extends State<NoFishFoundTabContainerPage> with TickerProviderStateMixin {
  late TabController tabviewController;

  @override
  void initState() {
    super.initState();
    tabviewController = TabController(length: 3, initialIndex: 1, vsync: this);
  }
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TabBarView(
                      ...
                      children: [
                        MyFishScreenPage.builder(context),
                        MyFishScreenPage.builder(context),
                        MyFishScreenPage.builder(context)
                      ],
                    ),
