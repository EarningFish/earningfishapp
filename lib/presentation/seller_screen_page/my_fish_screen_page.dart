...
class SellerScreenPage extends StatefulWidget {
  const SellerScreenPage({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<MyFishScreenBloc>(
      ...
      child: SellerScreenPage(),
    );
  }
}

class MyFishScreenPageState extends State<SellerScreenPage>
    with AutomaticKeepAliveClientMixin<SellerScreenPage> {
  @override
