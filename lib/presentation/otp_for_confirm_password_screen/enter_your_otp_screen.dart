...
class OtpConfirmPasswordScreen extends StatelessWidget {
  const OtpConfirmPasswordScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<EnterYourOtpBloc>(
      ...
      child: OtpConfirmPasswordScreen(),
    );
  }
          ...
          child: Column(
            children: [
              ...
              CustomElevatedButton(
                ...
                onPressed: () {
                  Navigator.pushNamed(context, AppRoutes.forgotPasswordConfirmScreen);
                },
              ),
              SizedBox(height: 5.v)
            ],
